...
class DAMicroTableViewCell: UITableViewCell {
    ...
    func populateMicroCell(firstImageUrlString: String, secondImageUrlString: String)
    {
        ...
        if secondImageUrlString == "NoImage" {
            secondImageView.isHighlighted = true
        }
        else{
